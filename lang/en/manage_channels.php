...
return [
    ...
    "channel_added"=>"✅ Channel added successfully!\nPlease make sure that the bot is admin in the channel",
    ...
    "send_channel_id"=>"Please send me the username of the channel you want to add\nRemember when you want to add channel you should send the channels username with @ if the channel is private you must send me a message from the channel",
    ...
    "its_private"=>"It's a private channel, please send me a message from the channel",
];
